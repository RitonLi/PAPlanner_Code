...
from qwen3_vl.mm_utils import KeywordsStoppingCriteria, get_model_name_from_path, tokenizer_image_token
...
def get_model_output(model, image_processor, tokenizer, video_path, qs, conv_mode="qwen_vl", num_video_frames=8):
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--video_dir", help="Directory containing video files.", default="~/videos"
    )
    parser.add_argument(
