...
def eval_model(args):
    ...
    jinfo = json.load(open("/home/lrt/workspace/video-mme/Video-MME.json"))
    folder = "/home/lrt/workspace/video-mme/videos"
    ...
    if args.total > 0:
        ...
        print(f"labeling {begin_idx}-{end_idx}, {chunk} from {len(jinfo)}")
