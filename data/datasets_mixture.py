...
def register_datasets_mixtures():
    ...
    envdrop = Dataset(
        ...
        data_path="/PATH_TO_DATA/Nav-Dataset/EnvDrop/annotations.json",
        image_path="/PATH_TO_DATA/Nav-Dataset/EnvDrop/videos",
    ...
    scanqa = Dataset(
        dataset_name="scanqa",
        dataset_type="torch",
        data_path="/PATH_TO_DATA/Nav-Dataset/ScanQA/annotations/ScanQA_v1.0_train_reformat.json",
        image_path="/PATH_TO_DATA/Nav-Dataset/ScanQA/videos",
    ...
    r2r = Dataset(
        dataset_name="r2r",
        dataset_type="vlnce",
        data_path="/PATH_TO_DATA/Nav-Dataset/R2R/annotations.json",
        image_path="/PATH_TO_DATA/Nav-Dataset/R2R/train",
    ...
    rxr = Dataset(
        dataset_name="rxr",
        dataset_type="vlnce",
        data_path="/PATH_TO_DATA/Nav-Dataset/RxR/annotations.json",
        image_path="/PATH_TO_DATA/Nav-Dataset/RxR/train",
    ...
    human = Dataset(
        dataset_name="human",
        dataset_type="vlnce",
        data_path="/PATH_TO_DATA/Nav-Dataset/Human/annotations.json",
        image_path="/PATH_TO_DATA/Nav-Dataset/Human/raw_frames/",
