...
from qwen3_vl.data.datasets_mixture import DATASETS_LEGACY
...
def register_datasets(name: Optional[str] = None):
    if name is None:
        name = os.environ.get("NAV_DATASETS", "default")
...
def build_dataset_legacy(
    ...
    from qwen3_vl.data.dataset import DummyDataset, LazyEnvDropDataset, LazySupervisedDataset, LazyVLNCEDataset
