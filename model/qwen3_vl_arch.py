...
from qwen3_vl.constants import IGNORE_INDEX, IMAGE_TOKEN_INDEX
from qwen3_vl.mm_utils import process_images
from qwen3_vl.model.configuration_qwen3_vl import Qwen3VlConfig
from qwen3_vl.model.language_model.builder import build_llm_and_tokenizer
from qwen3_vl.model.multimodal_encoder.builder import build_vision_tower
from qwen3_vl.model.multimodal_projector.builder import build_mm_projector
from qwen3_vl.model.utils import get_model_config
from qwen3_vl.train.sequence_parallel import get_pg_manager
from qwen3_vl.utils.media import extract_media
from qwen3_vl.utils.tokenizer import infer_stop_tokens, tokenize_conversation


# TODO decide whether should we use metaclass
class Qwen3VlMetaModel(ABC):
    ...
    def load_pretrained(cls, model_path_or_config, *args, **kwargs):
        ...
        elif isinstance(model_path_or_config, Qwen3VlConfig):
            config = model_path_or_config
        else:
            raise NotImplementedError(
                f"wrong type, {type(model_path_or_config)} \
                                      {isinstance(model_path_or_config, Qwen3VlConfig)}"
            )
...
class Qwen3VlMetaForCausalLM(ABC):
    """Meta interface for multimodal causal LM input preparation."""
