...
from qwen3_vl.constants import DEFAULT_IM_END_TOKEN, DEFAULT_IM_START_TOKEN, DEFAULT_IMAGE_PATCH_TOKEN
from qwen3_vl.model import *
from qwen3_vl.model.utils import is_mm_model
    ...
    **kwargs,
    ...
    if is_mm_model(model_path):
        ...
        if ("lora" in model_name.lower() or "dora" in model_name.lower()) and model_base is not None:
            ...
            model = Qwen3VLModel.from_pretrained(model_base, low_cpu_mem_usage=True, config=config, **kwargs)
        ...
        ## TODO @yunhao: mind fixing this
            ...
            model = Qwen3VLModel(config=config, low_cpu_mem_usage=True, **kwargs)
            tokenizer = model.tokenizer
    else:
        # Load language model
