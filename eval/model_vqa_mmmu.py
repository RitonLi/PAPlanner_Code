...
from qwen3_vl.eval.mmmu_utils.data_utils import CAT_SHORT2LONG, construct_prompt, process_single_sample
from qwen3_vl.eval.mmmu_utils.eval_utils import parse_choice
from qwen3_vl.utils import distributed as dist
...
def main():
    ...
    # Load model
    model = qwen3_vl.load(args.model_path, model_base=args.model_base, devices=devices)
